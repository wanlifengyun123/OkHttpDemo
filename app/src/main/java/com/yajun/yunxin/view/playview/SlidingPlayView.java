package com.yajun.yunxin.view.playview;
...
import com.yajun.yunxin.util.ViewUtil;
...
public class SlidingPlayView extends LinearLayout {
    ...
    /** 适配器. */
    private ViewPagerAdapter mAbViewPagerAdapter = null;
    ...
    public void initView(Context context){
        ...
        mAbViewPagerAdapter = new ViewPagerAdapter(context,mListViews);
...
//        mSlidingPlayView.setNavPageResources(R.mipmap.play_display, R.mipmap.play_hide);
