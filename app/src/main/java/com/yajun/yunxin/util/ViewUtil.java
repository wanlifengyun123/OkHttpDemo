...
import com.yajun.yunxin.view.pullview.ListViewFooter;
import com.yajun.yunxin.view.pullview.ListViewHeader;
...
public class ViewUtil {
	 ...
	 * 
	 * 描述：View树递归调用做适配.
	 * AbConfig.uiWidth = 1080;
	 * AbConfig.uiHeight = 700;
    ...
    public static boolean isNeedScale(View view){
    	...
    	if (view instanceof ListViewFooter){
    		return false;
        }
    	return true;
    }
